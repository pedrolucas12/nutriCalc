...
export const NutriMindFormSchema = z.object({
  ...
  weight: z
    ...
    .min(30, "Peso inválido")
    .max(300, "Peso inválido"),
  waist: z
    .number({ required_error: "Cintura é obrigatória" })
    .min(30, "Cintura inválida")
    .max(200, "Cintura inválida"),
  neck: z
    .number({ required_error: "Pescoço é obrigatório" })
    .min(15, "Pescoço inválido")
    .max(100, "Pescoço inválido"),
  age: z
    .number({ required_error: "Idade é obrigatória" })
    .min(15, "Idade mínima é 15")
