...
const NeuralNode = ({ index }: { index: number }) => {
  ...
  return (
    <div key={index} className="absolute w-2 h-2 rounded-full bg-purple-500/40" style={style} />
  );
};
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        <defs>
          <linearGradient id="purple-gradient" x1="0%" x2="100%" y1="0%" y2="100%">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32">
        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-fuchsia-500/20 rounded-full animate-pulse" />
        <div
