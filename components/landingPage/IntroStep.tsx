...
export default function IntroStep() {
  return (
    <div className="flex flex-col items-center text-center gap-4 p-4 text-secondary-800 dark:text-secondary-200">
      ...
      <h3 className={`${fontTitle.className} text-2xl font-semibold text-primary-300 dark:text-primary-100`}>
        Descubra Suas Métricas Essenciais
      </h3>
      <p className={`${fontSubtitle.className} text-md text-primary-400 dark:text-primary-200`}>
      ...
      <p className={`${fontSubtitle.className} text-sm font-medium text-primary-500 dark:text-primary-300`}>
