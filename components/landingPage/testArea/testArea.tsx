    ...
    <section className="w-full flex flex-col items-center justify-center " id="testArea">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-2">
          ...
          >
            Calcule seu{" "}
            <span className="font-bold text-primary-600 dark:text-primary-300">IMC</span>,{" "}
            <span className="font-bold text-primary-600 dark:text-primary-300">TMB</span> e{" "}
            <span className="font-bold text-primary-600 dark:text-primary-300">% de Gordura</span>{" "}
            em segundos. Veja na prática como a tecnologia pode transformar sua saúde!
          </p>
        </div>
